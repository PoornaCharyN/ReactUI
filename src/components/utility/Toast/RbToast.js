  ...
  return (
    <div className='jsx-code-wrapper'>
      ...
      <pre style={{marginRight: '20px', background: '#fff'}}>
        <code className='language-markup'>{`//Basic Toast with header and body
<Toast>
    <Toast.Header>
...
//Trigger Toast with a Button Control`}</code> <code className='language-javascript'>{`
function Example() {
  ...
  return (`}</code><code className='language-markup'>{`
    ...
    </Row>`}</code><code className='language-javascript'>{`
    );
  }`}
      </code>
    </pre>
