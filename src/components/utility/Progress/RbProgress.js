...
function RbProgressCode() {
  ...
  <ProgressBar now={60} />
  <label>Labeled ProgressBar</label>
  <ProgressBar now={progressValue} label={'progressValue'} /></code>
  <label>ProgressBar with variants</label>
  <div>
  ...
  <label>Striped ProgressBars</label>
  <div>
  ...
  <label>Animated ProgressBar</label>
